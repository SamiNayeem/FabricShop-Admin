                            ...
                            <>
                                ...
                                <div className="flex mb-4">
                                    <div className="mr-4">
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="text-gray-600 ml-2 p-1 border rounded"
                                        />
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        className="text-gray-600 text-sm mt-2 w-full p-2 border rounded"
                                    />
                                </div>
                                <div className="mt-4">
                                    <button
                                        className="bg-green-500 text-white py-2 px-4 rounded-full font-bold hover:bg-green-600 mr-2"
