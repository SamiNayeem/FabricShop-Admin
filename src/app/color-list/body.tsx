...
const Body = () => {
  ...
  const handleUpdate = async (id: number) => {
    try {
      const response = await axios.put(`/api/colors`, {
        id,
      ...
      if (response.status === 200) {
        setColors((prevColors) =>
          prevColors.map((color) =>
            color.id === id
              ? { ...color, name: updatedColorName, hexcode: updatedHexCode }
              : color
          )
        );
              ...
              <div className="px-4 py-5 sm:px-6">
                  ...
                  {editingColor === color.id ? (
                    ...
                    <div>
                      ...
                      <svg
                        ...
                        height="40px"
                        viewBox="0 -2 24 24"
                        id="meteor-icon-kit__solid-tshirt"
                        fill="none"
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M5.00009 9.3873L3.31634 9.9485C2.7924 10.1232 2.22609 9.84 2.05144 9.3161L0.0514698 3.31616C-0.105899 2.84405 0.107827 2.32807 0.552933 2.10552L4.55288 0.10555C4.69174 0.03612 4.84485 -0.00003 5.00009 -0.00003H8.00005C8.31481 -0.00003 8.61119 0.14817 8.80004 0.39997C9.61118 1.48148 10.6481 1.99995 12 1.99995C13.3519 1.99995 14.3888 1.48148 15.2 0.39997C15.3888 0.14817 15.6852 -0.00003 16 -0.00003H18.9999C19.1552 -0.00003 19.3083 0.03612 19.4471 0.10555L23.4471 2.10552C23.8922 2.32807 24.1059 2.84405 23.9485 3.31616L21.9486 9.3161C21.7739 9.84 21.2076 10.1232 20.6837 9.9485L18.9999 9.3873V18.9997C18.9999 19.552 18.5522 19.9997 17.9999 19.9997H6.00008C5.4478 19.9997 5.00009 19.552 5.00009 18.9997V9.3873z"
                          fill={color.hexcode}
                        />
                      </svg>
                    </div>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <button
                    ...
                    onClick={() =>
                      startEditing(color.id, color.name, color.hexcode)
                    }
                  >
                    <Image
                      src={"/images/edit.png"}
